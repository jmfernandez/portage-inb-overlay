...
SRC_URI="https://github.com/rstudio/rstudio/archive/v${PV}.tar.gz -> ${P}.tar.gz
	...
	https://s3.amazonaws.com/rstudio-buildtools/junit-${JUNITVER}.jar -> rstudio-junit-${JUNITVER}.jar
...
src_unpack() {
	...
	cp "${DISTDIR}"/rstudio-junit-${JUNITVER}.jar src/gwt/lib || die
}
