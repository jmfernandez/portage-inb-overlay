...
inherit autotools eutils java-pkg-opt-2 flag-o-matic multilib python-single-r1
...
IUSE="+cairo devil doc examples gtk gts java lasi nls perl postscript python qt4 ruby svg static-libs tcl webp X elibc_FreeBSD"
