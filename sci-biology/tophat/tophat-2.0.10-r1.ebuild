...
PATCHES=( "${FILESDIR}"/${P}-flags.patch "${FILESDIR}"/${P}_segment_juncs_segmentation_fault.patch "${FILESDIR}"/${P}_tophat_NoneType.patch "${FILESDIR}"/${P}_tophat_reports_segmentation_fault.patch )
