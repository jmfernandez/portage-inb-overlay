...
DESCRIPTION="SOAP accepting server (base class)"
...
DEPEND=">=perl-gcpan/XML-Compile-SOAP12-3.02
	>=perl-gcpan/Log-Report-1.05
	>=perl-gcpan/XML-Compile-WSDL11-3.02
	>=perl-gcpan/XML-Compile-SOAP-3.05
	>=perl-gcpan/XML-Compile-Tester-0.90
	>=perl-gcpan/XML-Compile-Cache-1.02
	>=perl-gcpan/XML-Compile-WSA-0.93
	>=perl-gcpan/XML-Compile-1.46
	dev-lang/perl"
