...
DEPEND=">=perl-gcpan/XML-Compile-WSDL11-3.02
	perl-gcpan/XML-Compile-Cache
	>=perl-gcpan/Log-Report-1.02
	perl-gcpan/XML-Compile-Tester
	perl-gcpan/XML-Compile-SOAP
	perl-gcpan/XML-Compile
	dev-lang/perl"
