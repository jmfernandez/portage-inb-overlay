...
S=${WORKDIR}/XML-SemanticCompare-0.91

DESCRIPTION="No description available"
HOMEPAGE="http://search.cpan.org/search?query=XML-SemanticCompare&mode=dist"
SRC_URI="mirror://cpan/authors/id/E/EK/EKAWAS/XML-SemanticCompare-0.91.tar.gz"
