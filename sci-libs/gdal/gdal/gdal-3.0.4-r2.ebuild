...
IUSE="armadillo +aux-xml curl debug doc fits geos gif gml hdf5 java jpeg jpeg2k lzma mdb mongodb mysql netcdf odbc ogdi opencl oracle pdf perl png postgres python spatialite sqlite threads webp xls zstd"
...
DEPEND="
	...
	mongodb? ( >=dev-libs/mongo-cxx-driver-3.5.0 )
	mysql? ( virtual/mysql )
