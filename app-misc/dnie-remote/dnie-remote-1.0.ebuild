...
SRC_URI="amd64? ( https://www.dnielectronico.es/descargas/Apps/DNIeRemoteSetup_${PV}-1_amd64.deb )
x86? ( https://www.dnielectronico.es/descargas/Apps/DNIeRemoteSetup_${PV}-1_i386.deb )"
