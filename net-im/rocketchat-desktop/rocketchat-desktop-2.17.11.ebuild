...
src_compile() {
	...
	#PATH="${PATH}:${S}/node_modules/.bin" NODE_ENV=production yarn gulp icons || die
	#PATH="${PATH}:${S}/node_modules/.bin" NODE_ENV=production yarn electron-builder --linux dir || die
