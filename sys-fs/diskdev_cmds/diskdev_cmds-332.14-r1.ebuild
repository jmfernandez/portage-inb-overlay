...
SRC_URI="http://www.opensource.apple.com/tarballs/apsl/diskdev_cmds-${PV}.tar.gz
		 mirror://gentoo/diskdev_cmds-${PVR}.patch.bz2"
LICENSE="APSL-2"
SLOT="0"
...
src_unpack() {
	unpack ${A}
	cd "${S}"
	epatch "${WORKDIR}"/diskdev_cmds-${PVR}.patch
}
